                ...
                public void handle(MouseEvent mouseEvent) {
                    ...
                    if (mouseEvent.isControlDown()
                        ...
                        if (changeInX > 0) {
                            ...
                            whiteImg = new Image("img/tool/arrowright.png");
                            cellView.whiteImgView.setImage(whiteImg);
                        }
                        else if (changeInX < 0) {
                            System.out.println("moving left");
                            whiteImg = new Image("img/tool/arrowleft.png");
                            cellView.whiteImgView.setImage(whiteImg);
                        }
                        if (changeInY > 0) {
                            System.out.println("moving down");
                            whiteImg = new Image("img/tool/arrowdown.png");
                            cellView.whiteImgView.setImage(whiteImg);
                        }
                        else if (changeInY < 0) {
                            System.out.println("moving up");
                            whiteImg = new Image("img/tool/arrowup.png");
                            cellView.whiteImgView.setImage(whiteImg);
                        }
                    }
                }
...
//            cellView.setOnMouseExited(new EventHandler<MouseEvent>() {
//                @Override
//                public void handle(MouseEvent mouseEvent) {
//                    if (MazeController.canDraw
//                            && cellView.isPath) {
//                        System.out.println("zhu zhu huahua");
//                        cellView.isPath = true;
//                        Image whiteImg = new Image("img/tool/point.png");
//                        cellView.whiteImgView.setImage(whiteImg);
//                    }
//                }
//            });
